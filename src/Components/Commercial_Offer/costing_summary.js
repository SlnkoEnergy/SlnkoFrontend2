...
const Summary = () => {
    ...
    const [offerData, setOfferData] = useState({
      ...
      const SumOf_Total_GST_Value =
        ...
        const Total_GST_Solar_Datalogger = Math.round((TotalVal2*12/100)+(TotalVal20*18/100));
        const Total_with_GST_Solar_Datalogger = Math.round((TotalVal2*12/100+TotalVal2)+(TotalVal20*18/100+TotalVal20));

        const Total_Basic_MMS_Fastner = Math.round(TotalVal3+TotalVal4);
        const Total_GST_MMS_Fastner = Math.round((TotalVal3*18/100) + (TotalVal4*18/100));
        const Total_with_GST_MMS_Fastner = Math.round((TotalVal3*18/100+TotalVal3)+(TotalVal4*18/100+TotalVal4));


        const Total_Basic_Cables = Math.round((TotalVal5)+(TotalVal6)+(TotalVal7)+(TotalVal8)+(TotalVal9)+(TotalVal10)+(TotalVal11)+(TotalVal12));
        const Total_GST_Cables = Math.round((TotalVal5*18/100)+(TotalVal6*18/100) +(TotalVal7*18/100) +(TotalVal8*18/100) +(TotalVal9*18/100) +(TotalVal10*18/100) +(TotalVal11*18/100) +(TotalVal12*18/100) );
        const Total_with_GST_Cables = Math.round((TotalVal5*18/100+TotalVal5)+ (TotalVal6*18/100+TotalVal6)+(TotalVal7*18/100+TotalVal7) + (TotalVal8*18/100+TotalVal8)+ (TotalVal9*18/100+TotalVal9)+ (TotalVal10*18/100+TotalVal10)+(TotalVal11*18/100+TotalVal11) +(TotalVal12*18/100+TotalVal12) );


        const Total_Basic_Electrical_Equipment = Math.round((TotalVal13)+ (scmWeekly2(offerData.transformer, offerData.ac_capacity, offerData.evacuation_voltage)+ (scmWeekly3(offerData.evacuation_voltage)))+(TotalVal21)+(TotalVal22));
        const Total_GST_Electrical_Equipment = Math.round((TotalVal13*18/100)+ (scmWeekly2(offerData.transformer, offerData.ac_capacity, offerData.evacuation_voltage)*18/100) +((scmWeekly3(offerData.evacuation_voltage)*18/100))+(TotalVal21*18/100)+(TotalVal22*18/100));
        const Total_with_GST_Electrical_Equipment = Math.round((TotalVal13*18/100+TotalVal13)+(scmWeekly2(offerData.transformer, offerData.ac_capacity, offerData.evacuation_voltage)*18/100+scmWeekly2(offerData.transformer, offerData.ac_capacity, offerData.evacuation_voltage)) + ((scmWeekly3(offerData.evacuation_voltage)*18/100+scmWeekly3(offerData.evacuation_voltage)))+(TotalVal21*18/100+TotalVal21)+(TotalVal22*18/100+TotalVal22));


        const Total_Basic_Other_Material = Math.round(TotalVal16+TotalVal17+TotalVal18+TotalVal19+TotalVal23);
        const Total_Gst_Other_Material = Math.round((TotalVal16*18/100)+(TotalVal17*18/100)+(TotalVal18*18/100)+(TotalVal19*18/100)+(TotalVal23*18/100));
        const Total_with_Gst_Other_Material = Math.round((TotalVal16*18/100+TotalVal16)+(TotalVal17*18/100+TotalVal17)+(TotalVal18*18/100+TotalVal18)+(TotalVal19*18/100+TotalVal19)+(TotalVal23*18/100+TotalVal23));


        const Total_Basic_Installation_Charges = Math.round(TotalVal24+TotalVal25+TotalVal26);
        const Total_GST_Installation_Charges = Math.round((TotalVal24*18/100)+((TotalVal25 * 18) / 100)+((TotalVal26 * 18) / 100));
        const Total_with_GST_Installation_Charges = Math.round((TotalVal24*18/100+TotalVal24)+((TotalVal25 * 18) / 100 + TotalVal25)+((TotalVal26 * 18) / 100 + TotalVal26));


        const Total_Basic_Transportatiom_Insurance = Math.round(TotalVal27+scmWeekly5);
        const Total_GST_Transportatiom_Insurance = Math.round(((TotalVal27 * 18) / 100)+((scmWeekly5 * 18) / 100));
        const Total_with_GST_Transportatiom_Insurance = Math.round(((TotalVal27 * 18) / 100 + TotalVal27)+((scmWeekly5 * 18) / 100 + scmWeekly5));


        const Total_Plant_Cost_1 = Math.round((TotalVal1) + (Total_Basic_Solar_Datalogger) + (Total_Basic_MMS_Fastner) + (Total_Basic_Cables) + (Total_Basic_Electrical_Equipment)+
        (Total_Basic_Other_Material) + (Total_Basic_Installation_Charges) + (Total_Basic_Transportatiom_Insurance) + (TotalVal32));


        const Total_Plant_Cost_GST_1 = Math.round((TotalVal1*12/100) + (Total_GST_Solar_Datalogger) + (Total_GST_MMS_Fastner) + (Total_GST_Cables) + (Total_GST_Electrical_Equipment)+
        (Total_Gst_Other_Material) + (Total_GST_Installation_Charges) + (Total_GST_Transportatiom_Insurance) + ((TotalVal32 * 18) / 100))


        const Total_Plant_Cost_with_GST_1 = Math.round((TotalVal1*12/100+TotalVal1) + (Total_with_GST_Solar_Datalogger) + (Total_with_GST_MMS_Fastner) + (Total_with_GST_Cables)  + 
        (Total_with_GST_Electrical_Equipment) + (Total_with_Gst_Other_Material) + (Total_with_GST_Installation_Charges) + (Total_with_GST_Transportatiom_Insurance)+
        (((TotalVal32 * 18) / 100 + TotalVal32)));



        const Total_Basic_GSS_Equipment = (2 * ct_pt_cal) + (3 * abt_cal) + (totalVCB) + (scmWeekly4(offerData.ac_capacity) * 1);
        const Total_GST_GSS_Equipment = ((ct_pt_cal * 2 * 18) / 100) + ((abt_cal * 3 * 18) / 100) + ((totalVCB * 18) / 100) + ((scmWeekly4(offerData.ac_capacity) * 1 * 18) / 100 );
        const Totalwith_GST_GSS_Equipment = ((ct_pt_cal * 2 * 18) / 100 + ct_pt_cal * 2) + ((abt_cal * 3 * 18) / 100 + abt_cal * 3) + ((totalVCB * 18) / 100 + totalVCB) + ((scmWeekly4(offerData.ac_capacity) * 1 * 18) / 100 + scmWeekly4(offerData.ac_capacity) * 1 );


        const Total_Basic_GSS_Cost = (Total_Basic_GSS_Equipment) + (offerData.transmission_length * bdRate.transmission_line);
        const Total_GST_GSS_Cost = (Total_GST_GSS_Equipment) + (((offerData.transmission_length * bdRate.transmission_line * 18) / 100));
        const Total_with_GST_Cost = (Totalwith_GST_GSS_Equipment) + ((( offerData.transmission_length * bdRate.transmission_line) * 18) /100 +bdRate.transmission_line *offerData.transmission_length);


        const Final_Total_Plant_Cost = (Total_Plant_Cost_1) + (Total_Basic_GSS_Cost);
        const Final_Total_GST_Plant_Cost = Total_Plant_Cost_GST_1;
        ...
        const Cost_Without_Module_GST = (Final_Total_GST_Plant_Cost) - ((TotalVal1*12/100));
        const Cost_Without_Module_with_GST = (Final_Total_with_GST_Plant_Cost) - ((TotalVal1*12/100+TotalVal1));
                ...
                <Table className="table-header-Summary">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{Total_Basic_Solar_Datalogger}</td>
                      <td>{Total_GST_Solar_Datalogger}</td>
                      <td>{Total_with_GST_Solar_Datalogger}</td>
                    </tr>
    
                    <tr>
                      <td>MMS With Fasteners</td>
                      <td>{Total_Basic_MMS_Fastner}</td>
                      <td>{Total_GST_MMS_Fastner}</td>
                      <td>{Total_with_GST_MMS_Fastner}</td>
                    </tr>
    
                    <tr>
                      <td>Cables</td>
                      <td>{Total_Basic_Cables}</td>
                      <td>{Total_GST_Cables}</td>
                      <td>{Total_with_GST_Cables}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>{Total_Basic_Electrical_Equipment}</td>
                      <td>{Total_GST_Electrical_Equipment}</td>
                      <td>{Total_with_GST_Electrical_Equipment}</td>
                    </tr>
    
                    <tr>
                      <td>Other Balance of Material</td>
                      <td>{Total_Basic_Other_Material}</td>
                      <td>{Total_Gst_Other_Material}</td>
                      <td>{Total_with_Gst_Other_Material}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>{Total_Basic_Installation_Charges}</td>
                      <td>{Total_GST_Installation_Charges}</td>
                      <td>{Total_with_GST_Installation_Charges}</td>
                    </tr>
    
                    <tr>
                      <td>Transportation & Insurance</td>
                      <td>{Total_Basic_Transportatiom_Insurance}</td>
                      <td>{Total_GST_Transportatiom_Insurance}</td>
                      <td>{Total_with_GST_Transportatiom_Insurance}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td style={{ backgroundColor: "#FFF2CC" }}>{Total_Plant_Cost_1}</td>
                      <td style={{ backgroundColor: "#FFF2CC" }}>{Total_Plant_Cost_GST_1}</td>
                      <td style={{ backgroundColor: "#FFF2CC" }}>{Total_Plant_Cost_with_GST_1}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>{Total_Basic_GSS_Equipment}</td>
                      <td>{Total_GST_GSS_Equipment}</td>
                      <td>{Totalwith_GST_GSS_Equipment}</td>
                    </tr>
    
                    <tr>
                      <td>Transmission Line</td>
                      <td>{offerData.transmission_length * bdRate.transmission_line}</td>
                      <td>{(
                      ...
                      <td>{(Math.round( offerData.transmission_length * bdRate.transmission_line) * 18) /100 +bdRate.transmission_line *offerData.transmission_length}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style={{ backgroundColor: "#FFF2CC" }}>{Total_Basic_GSS_Cost}</td>
                      <td style={{ backgroundColor: "#FFF2CC" }}></td>
                      <td style={{ backgroundColor: "#FFF2CC" }}>{Total_with_GST_Cost}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style={{ backgroundColor: "#ead34d" }}>{Final_Total_Plant_Cost}</td>
                      <td style={{ backgroundColor: "#ead34d" }}>{Final_Total_GST_Plant_Cost}</td>
                      <td style={{ backgroundColor: "#ead34d" }}>{Final_Total_with_GST_Plant_Cost}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style={{ backgroundColor: "#D9D9D9" }}>{Cost_Without_Module}</td>
                      <td>{Cost_Without_Module_GST}</td>
                      <td>{Cost_Without_Module_with_GST}</td>
                    </tr>
